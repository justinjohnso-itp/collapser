...
def getSequenceToRender(parseParams):
	...
	choices["Ch6ResearchResults"] = ["Ch6ResearchResults", 6, "It was a blurry copy of an old newspaper from around the turn of the century. I didn't see the relevance at first until I noticed an address, and almost choked on my tea."]
